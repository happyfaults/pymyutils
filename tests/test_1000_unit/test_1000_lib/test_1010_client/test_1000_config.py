...
def test_1000_config_manager():
    ...
    from myutils.lib.client.config import Manager
    import myutils_c
    ...
    assert m.base_modname == 'myutils_c'

    from myutils.lib.lang.namespace import Type as NSType
    from myutils.lib.client import Context as cls
    ...
    with pytest.raises(ModuleNotFoundError):
        # trying to load myutils_c.lib which doesn't exist
        m.loadConfig(cls, cfg)

    # test later in myutils.client module
    #assert cls.CONFIG_TYPE is myutils_c.Config
