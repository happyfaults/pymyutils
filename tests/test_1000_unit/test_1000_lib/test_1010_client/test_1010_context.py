...
def test_1000_factory():
    from myutils.lib.client import Factory
    cfg = {
        'a': 1
    }
    ...
    from myutils.lib.client.conn import Manager as ConnMgr
    from myutils.lib.client.config import Manager as ConfigMgr
...
def test_1010_level():
    from myutils.lib.client import Level
...
def test_1020_context():
    ...
    from myutils.client import Interactor, Factory
